...
const EmailForm = () => {
  ...
  const emailForm = useForm<z.infer<typeof oldEmailSchema>>({
    ...
    defaultValues: { email: "", oldEmail: "rabbimob@gmail.com" },
  });
  ...
  const onEmailSubmit = (data: z.infer<typeof oldEmailSchema>) => {
    // Handle form submission
    console.log(data);
    setVerify(true);
  };
  const onVerifySubmit = (data: z.infer<typeof otpSchema>) => {
    // Handle form submission
    console.log(data);
    setVerify(false);
  };
